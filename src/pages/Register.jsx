...
export default function RegisterPage() {
  ...
  return (
    ...
    >
      ...
      {/* Formulaire */}
      <div className="relative flex-[0_0_60%] max-w-[600px] max-h-[85vh] ml-[-170px] bg-white/20 backdrop-blur-md z-10 text-gray-800 rounded-xl p-10 shadow-xl border border-white/40 overflow-y-auto">
